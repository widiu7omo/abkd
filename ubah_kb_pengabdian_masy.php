...
<?php
    ...
    $result2 = mysqli_query($conn, "SELECT *, SUM(bk_sks) + SUM(kinerja_sks) AS tsks FROM `kb_pm` WHERE nomor_kbpm = '$nomor_kbpm2'");

    while ($data = mysqli_fetch_array($result2)) {
        $tahun_ajaran = $data['tahun_ajaran'];
        $nomor_kbpm = $data['nomor_kbpm'];
        $tsks = $data['tsks'];
    }
?>
		...
		<div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header">
						<h2>
							EDIT KINERJA BIDANG PENGABDIAN MASYARAKAT
						</h2>
					</div>
                    <?php
                        $id_kbpm = $_GET['id_kbpm'];

                        $result2 = mysqli_query($conn, "SELECT * FROM `kb_pengabdian_masy` WHERE id_kbpm = '$id_kbpm'");
                    ...
                    ?>
					<div class="body">
						<form action="pages/ubah_kb_pengabdian_masy.php" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="id_user" value="<?php echo $id_user?>">
                            <div class="row clearfix">
                                <div class="form-group form-float">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input type="hidden" id="" name="id_kbpm" value="<?php echo $id_kbpm; ?>">
                                            <div class="form-line">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="form-line" style="bottom: 25px">
                                                ...
                                                <small class="text-danger">* file harus berbentuk pdf</small>
                                                <input type="file" accept=".pdf" id="input_file" name="file" class="form-control">
