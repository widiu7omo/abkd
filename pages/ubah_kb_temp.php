<?php
	...
	if (isset($_POST['simpan'])) {
		...
		if (in_array($ekstensi, $ekstensi_diperbolehkan) === true && in_array($ekstensi1, $ekstensi_diperbolehkan1) === true) {
			...
			$query = "INSERT INTO kbp_temp (id_kbp, nomor_kbp, jenis_kegiatan, bk_buktipenugasan, bk_sks, masa_penugasan, kinerja_sks, rekomendasi, kb_dokumen, id_user) VALUES (NULL,'$id_kbp', '$jenis_kegiatan', '$nama1', '$bk_sks', '$masa_penugasan', '$kinerja_sks', '$rekomendasi', '$nama', '$id_user')";
