        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            EDIT KINERJA BIDANG PENDIDIKAN
                        </h2>
                    </div>
					<?php
					$id_kbp = $_GET['id_kbp'];

					$result2 = mysqli_query( $conn, "SELECT * FROM `kb_pendidikan` WHERE id_kbp = '$id_kbp'" );
					...
					?>
                    <div class="body">
                        <form action="pages/ubah_kb_pendidikan.php" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="id_user" value="<?php echo $id_user ?>">
                            <div class="row clearfix">
                                <div class="form-group form-float">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input type="hidden" id="" name="id_kbp" value="<?php echo $id_kbp; ?>">
                                            <div class="form-line">
                                                <label class="form-label">JENIS KEGIATAN</label>
                                                <input type="text" id="" name="jenis_kegiatan" class="form-control"
                                                       value="<?php echo $jenis_kegiatan; ?>">
                                            </div>
                                        </div>
                                    </div>
