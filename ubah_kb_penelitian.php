...
<?php
    ...
    $result2 = mysqli_query($conn, "SELECT *, SUM(bk_sks) + SUM(kinerja_sks) AS tsks FROM `kb_penelitian` WHERE nomor_kbpl = '$nomor_kbpl2'");

    while ($data = mysqli_fetch_array($result2)) {
        $tahun_ajaran = $data['tahun_ajaran'];
        $nomor_kbpl = $data['nomor_kbpl'];
        $tsks = $data['tsks'];
    }
?>
		...
		<div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header">
						<h2>
							EDIT KINERJA BIDANG PENELITIAN
						</h2>
					</div>
                    <?php
                        $id_kbpl = $_GET['id_kbpl'];

                        $result2 = mysqli_query($conn, "SELECT * FROM `kb_penelitian` WHERE id_kbpl = '$id_kbpl'");
                    ...
                    ?>
					<div class="body">
						<form action="pages/ubah_kb_penelitian.php" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="id_user" value="<?php echo $id_user?>">
                            <div class="row clearfix">
                                <div class="form-group form-float">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <input type="hidden" id="" name="id_kbpl" value="<?php echo $id_kbpl; ?>">
                                            <div class="form-line">
